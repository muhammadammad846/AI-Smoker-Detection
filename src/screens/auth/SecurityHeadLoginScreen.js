...
const SecurityHeadLoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    if (!email || !password) {
      setError('AUTHORIZATION ERROR: DATA FRAGMENTS MISSING');
      return;
    }
    setLoading(true);
    setError('');
    try {
      ...
      setError(err.message || 'STATUS 403: COMMAND REJECTED');
    } finally {
      setLoading(false);
    }
  };
        ...
        <LinearGradient colors={theme.colors.headerGradient} style={styles.headerGradient}>
          ...
          <View style={styles.headerContent}>
            <View style={styles.iconCircle}>
              <Icon name="brain" size={52} color={theme.colors.success} />
            </View>
            <Text style={styles.titleText}>STRATEGIC OVERSIGHT</Text>
            <Text style={styles.subtitleText}>DEPARTMENT HEAD ACCESS</Text>
          </View>
        </LinearGradient>
      </View>
          ...
          <Card style={styles.loginCard} elevation={4}>
            <Card.Content style={styles.cardInner}>
              <TextInput
                ...
                style={styles.input}
                left={<TextInput.Icon icon="account-tie-outline" iconColor="#6B7280" />}
              />
              ...
              <TextInput
                ...
                activeOutlineColor={theme.colors.success}
                style={styles.input}
                left={<TextInput.Icon icon="shield-star-outline" iconColor="#6B7280" />}
              />
              ...
              <View style={styles.securityTag}>
                ...
                <Text style={[styles.securityText, { color: theme.colors.success }]}>VERIFIED EXECUTIVE STATUS</Text>
              </View>
            </Card.Content>
          </Card>

          <Text style={styles.forgotText}>CONTACT ADMIN FOR DISASTER RECOVERY</Text>
        </ScrollView>
      </KeyboardAvoidingView>
