...
['AdminNavigator.js', 'StudentNavigator.js', 'GuardNavigator.js', 'SecurityHeadNavigator.js'].forEach(f => {
    ...
    if (!content.includes("tabBarLabelPosition: 'below-icon'")) {
        content = content.replace(/screenOptions=\{{0,2}\(\{ route \}\) => \(\{/, "screenOptions={({ route }) => ({\n        tabBarLabelPosition: 'below-icon',");
    }
    ...
    if (startIdx !== -1) {
        ...
        console.log('Could not find tabBarStyle in', f);
    }
});
